...
export function Logo({small=false}:{small?:boolean}){return <Link href="/" className={'brand '+(small?'small':'')} aria-label="HOMELAND home"><img src="/homeland.png" alt="HOMELAND Logo" width={small?25:33} height={small?27:35} /><span>HOMELAND<span className="brand-period">.</span></span></Link>}
